$(document).ready(function(){
	...
	$.post("pages/legnepsz_nintendoswitchjatek/lekerdez.php", function(data, status){
        //alert("Data: " + data + "\nStatus: " + status);
		...
		$(".jatekkep").click(function(){
			...
			$.post("pages/legnepsz_nintendoswitchjatek/nezettseg_novel.php",adatok1,function(){
						
			});
			$.post("pages/legnepsz_nintendoswitchjatek/leiras_lekerdez.php",adatok1,function(eredmeny1){
       ...
       // alert(this.id);
		...
		var adatok=
			...
			termekar:z[2]
			 ...
			 $.post("pages/legnepsz_nintendoswitchjatek/kosarba_beszuras.php",adatok,function(eredmeny){
