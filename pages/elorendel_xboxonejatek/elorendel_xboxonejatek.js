$(document).ready(function(){
	...
	$.post("pages/elorendel_xboxonejatek/lekerdez.php", function(data, status){
        //alert("Data: " + data + "\nStatus: " + status);
	...
	if(tomb[i].jatek_keszletid ==0)
		...
		$(".jatekkep").click(function(){
			...
			$.post("pages/elorendel_xboxonejatek/nezettseg_novel.php",adatok1,function(){
						
			});
			$.post("pages/elorendel_xboxonejatek/leiras_lekerdez.php",adatok1,function(eredmeny1){
       ...
       // alert(this.id);
		...
		var adatok=
			...
			termekar:z[2]
			 ...
			 $.post("pages/elorendel_xboxonejatek/kosarba_beszuras.php",adatok,function(eredmeny){
