$(document).ready(function(){
	...
	$.post("pages/elorendel_nintendoswitchjatek/lekerdez.php", function(data, status){
        //alert("Data: " + data + "\nStatus: " + status);
		...
		szoveg+='<img class="jatekkep" id = "'+tomb[i].jatek_id+'"  src="kepek/'+tomb[i].jatek_kep+'" style =width:200px;">';
		...
		$(".jatekkep").click(function(){
			...
			$.post("pages/elorendel_nintendoswitchjatek/nezettseg_novel.php",adatok1,function(){
						
			});
			$.post("pages/elorendel_nintendoswitchjatek/leiras_lekerdez.php",adatok1,function(eredmeny1){
       ...
       // alert(this.id);
		...
		var adatok=
			...
			termekar:z[2]
			 ...
			 $.post("pages/elorendel_nintendoswitchjatek/kosarba_beszuras.php",adatok,function(eredmeny){
