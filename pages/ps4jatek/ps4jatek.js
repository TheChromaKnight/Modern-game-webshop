$(document).ready(function(){
	...
	$.post("pages/ps4jatek/lekerdez.php", function(data, status){
        //alert("Data: " + data + "\nStatus: " + status);
	...
	if(tomb[i].jatek_keszletid ==0)
		...
		$(".jatekkep").click(function(){
			...
			$.post("pages/ps4jatek/nezettseg_novel.php",adatok1,function(){
						
			});
			$.post("pages/ps4jatek/leiras_lekerdez.php",adatok1,function(eredmeny1){
       ...
       // alert(this.id);
		...
		var adatok=
			...
			termekar:z[2]
			 ...
			 $.post("pages/ps4jatek/kosarba_beszuras.php",adatok,function(eredmeny){
