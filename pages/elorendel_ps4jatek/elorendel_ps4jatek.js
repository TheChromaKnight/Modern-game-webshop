$(document).ready(function(){
	...
	$.post("pages/elorendel_ps4jatek/lekerdez.php", function(data, status){
        //alert("Data: " + data + "\nStatus: " + status);
		...
		$(".jatekkep").click(function(){
			...
			$.post("pages/elorendel_ps4jatek/nezettseg_novel.php",adatok1,function(){
						
			});
			$.post("pages/elorendel_ps4jatek/leiras_lekerdez.php",adatok1,function(eredmeny1){
       ...
       // alert(this.id);
		...
		var adatok=
			...
			termekar:z[2]
			 ...
			 $.post("pages/elorendel_ps4jatek/kosarba_beszuras.php",adatok,function(eredmeny){
