$(document).ready(function(){
	...
	$.post("pages/pcjatek/lekerdez.php", function(data, status){
        //alert("Data: " + data + "\nStatus: " + status);
		...
		szoveg+='<input type="text" id = "jatek_kateg_kereses" placeholder="Keresés..." >';
		szoveg+='<button type="button" class = "keres_kateg_gomb">Keresés</button>';
		...
		szoveg+='<div class=" col-sm-12 col-md-10">'; // 2.rész
		...
		$(".jatekkep").click(function(){
			...
			$.post("pages/pcjatek/nezettseg_novel.php",adatok1,function(){
						
			});
			$.post("pages/pcjatek/leiras_lekerdez.php",adatok1,function(eredmeny1){
       ...
       // alert(this.id);
		...
		var adatok=
			...
			termekar:z[2]
			 ...
			 $.post("pages/pcjatek/kosarba_beszuras.php",adatok,function(eredmeny){
