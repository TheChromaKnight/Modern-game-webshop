$(document).ready(function(){
	...
	$.post("pages/leguj_pcjatek/lekerdez.php", function(data, status){
        //alert("Data: " + data + "\nStatus: " + status);
		...
		$("#tablazat").html(szoveg);
			...
			$.post("pages/leguj_pcjatek/nezettseg_novel.php",adatok1,function(){
						
			});
			$.post("pages/leguj_pcjatek/leiras_lekerdez.php",adatok1,function(eredmeny1){
       ...
       // alert(this.id);
		...
		var adatok=
			...
			termekar:z[2]
			 ...
			 $.post("pages/leguj_pcjatek/kosarba_beszuras.php",adatok,function(eredmeny){
