$(document).ready(function(){
	...
	$.post("pages/leguj_nintendoswitchjatek/lekerdez.php", function(data, status){
        //alert("Data: " + data + "\nStatus: " + status);
	...
	if(tomb[i].jatek_keszletid == 0 || tomb[i].jatek_keszletid == 3 || tomb[i].jatek_ar == 0)
		...
		$(".jatekkep").click(function(){
			...
			$.post("pages/leguj_nintendoswitchjatek/nezettseg_novel.php",adatok1,function(){
						
			});
			$.post("pages/leguj_nintendoswitchjatek/leiras_lekerdez.php",adatok1,function(eredmeny1){
       ...
       // alert(this.id);
		...
		var adatok=
			...
			termekar:z[2]
			 ...
			 $.post("pages/leguj_nintendoswitchjatek/kosarba_beszuras.php",adatok,function(eredmeny){
