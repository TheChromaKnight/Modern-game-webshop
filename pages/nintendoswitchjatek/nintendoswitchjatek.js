$(document).ready(function(){
	...
	$.post("pages/nintendoswitchjatek/lekerdez.php", function(data, status){
        //alert("Data: " + data + "\nStatus: " + status);
	...
	if(tomb[i].jatek_keszletid ==0)
		...
		$(".jatekkep").click(function(){
			...
			$.post("pages/nintendoswitchjatek/nezettseg_novel.php",adatok1,function(){
						
			});
			$.post("pages/nintendoswitchjatek/leiras_lekerdez.php",adatok1,function(eredmeny1){
       ...
       // alert(this.id);
		...
		var adatok=
			...
			termekar:z[2]
			 ...
			 $.post("pages/nintendoswitchjatek/kosarba_beszuras.php",adatok,function(eredmeny){
